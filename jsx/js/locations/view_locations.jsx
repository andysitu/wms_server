          ...
          {this.state.locations.map((location) => {
            return (
              <LocationRow key={location.id} 
                location={location} 
                onClick_delete_btn={this.onClick_delete_btn}
                />
            );
          })}
        </tbody>
  ...
  render() {
    ...
    <tr key={this.state.location.id}>
      ...
      <td>
        ...
        <button type="button" className="btn btn-sm btn-outline-danger" onClick={this.props.onClick_delete_btn}>
